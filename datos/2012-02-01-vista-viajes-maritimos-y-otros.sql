...
SELECT p.id PID, v.ID, e.id ETAPA, p2.ID PROXDEST, b.ID_BUQUE, b.NOMBRE, b.NRO_OMI, b.MATRICULA, b.SDIST, b.BANDERA, trunc(v.LATITUD,2), trunc(v.LONGITUD,2),
...
UPDATE tbl_puntodecontrol SET uso=0;
