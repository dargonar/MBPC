        ...
        return this.each(function () {
            ...
            setColWidth = function () {
                var initwidth = 0,
                    ...
                    aw, tw = 0,
                    gw = 0,
                    msw = ts.p.multiselectWidth,
                    sgw = ts.p.subGridWidth,
                    rnw = ts.p.rownumWidth,
                    cl = ts.p.cellLayout,
                    cr;
                ...
                if (! (nm == "cb" || nm == "subgrid" || nm == "rn")) {
                    if (ts.p.viewsortcols[2] == false) {
                        $(".ui-grid-ico-sort", this).click(function () {
                            sortData(ht.id, j, true, $(this).attr("sort"));
                            return false
                        })
                    } else {
            ...
            $(grid.hDiv).css({
                width: grid.width + "px"
            }).addClass("ui-state-default ui-jqgrid-hdiv").append(hb).bind("selectstart", function () {
                return false
            });
            $(hb).append(hTable);
            if (hg) {
            ...
            $(grid.cDiv).append(arf).append("<span class='ui-jqgrid-title'>" + ts.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix");
        ...
        setGridWidth: function (nwidth, shrink) {
            return this.each(function () {
                var $t = this,
                    ...
                    aw, gw = 0,
                    tw = 0,
                    msw = $t.p.multiselectWidth,
                    sgw = $t.p.subGridWidth,
                    rnw = $t.p.rownumWidth,
                    cl = $t.p.cellLayout,
                    cr;
                if (!$t.grid) {
            ...
            return this.each(function () {
                ...
                var j = function () {
                    ...
                    a.each(g.p.colModel, function (r, u) {
                        ...
                        case "select":
                            var t;
                            a("select[name=" + l + "] option", g.grid.hDiv).each(function (v) {
                                if (v == 0) {
                                    this.selected = true
                                }
                                if (a(this).text() == m) {
                ...
                var h = a("<tr class='ui-search-toolbar' role='rowheader'></tr>"),
                    d, i, e;
                a.each(g.p.colModel, function (s, o) {
                    var u = this;
                    d = a("<th role='columnheader' class='ui-state-default ui-th-column'></th>");
                    i = a("<div style='width:100%;position:relative;'></div>");
                    if (this.hidden === true) {
                    ...
                    if (this.search) {
                        ...
                        case "select":
                            ...
                            break;
                        case "text":
                            var t = e.defaultValue ? e.defaultValue : "";
                            a(i).append("<input type='text' style='width:95%;padding:0px;' name='" + (u.index || u.name) + "' id='gs_" + u.name + "' value='" + t + "'/>");
                            if (e.attr) {
                            ...
                            if (b.autosearch === true) {
                                a("input", i).keypress(function (x) {
                                    var n = x.charCode ? x.charCode : x.keyCode ? x.keyCode : 0;
                                    if (n == 13) {
                                        c();
                                        return false
                                    }
...
var createModal = function (i, d, a, k, m, l) {
    ...
    h.className = "ui-widget ui-widget-content ui-corner-all ui-jqdialog";
    h.id = i.themodal;
    var b = document.createElement("div");
    b.className = "ui-jqdialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix";
    b.id = i.modalhead;
    jQuery(b).append("<span class='ui-jqdialog-title'>" + a.caption + "</span>");
    ...
    jQuery(g).addClass("ui-jqdialog-content ui-widget-content").attr("id", i.modalcontent);
    jQuery(g).append(d);
    h.appendChild(g);
    jQuery(h).prepend(b);
    if (l === true) {
    ...
    jQuery("a.ui-jqdialog-titlebar-close", b).click(function (o) {
        var n = jQuery("#" + i.themodal).data("onClose") || a.onClose;
        var p = jQuery("#" + i.themodal).data("gbox") || a.gbox;
    ...
    if (a.resize) {
        if (jQuery.fn.jqResize) {
            jQuery(h).append("<div class='jqResize ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se ui-icon-grip-diagonal-se'></div>");
            jQuery("#" + i.themodal).jqResize(".jqResize", i.scrollelm ? "#" + i.scrollelm : false)
        } else {
            try {
                jQuery(h).resizable({
                    handles: "se",
...
function info_dialog(a, d, b) {
    var c = "<div id='info_id'>";
    c += "<div align='center'><br />" + d + "<br /><br />";
    c += "<input type='button' size='10' id='closedialog' class='jqmClose EditButton' value='" + b + "' />";
    c += "</div></div>";
    createModal({
    ...
    "", "", true);
    jQuery("#closedialog", "#info_id").addClass("ui-state-default ui-corner-all").height(21).css({
        padding: " .2em .5em",
        cursor: "pointer"
    }).hover(function () {
    ...
    if (jQuery.fn.jqm) {} else {
        jQuery("#closedialog", "#info_id").click(function (f) {
...
function createEl(h, r, f) {
    ...
    case "select":
        ...
        var q = r.multiple === true ? true : false;
        if (r.dataUrl != null) {
            ...
            if (r.value) {
                ...
                if (typeof r.value === "string") {
                    ...
                    for (k = 0; k < c.length; k++) {
                        ...
                        if (q && jQuery.inArray(jQuery.trim(n[1]), j) > -1) {
                            d.selected = "selected"
                        }
                        g.appendChild(d)
                    }
                    ...
                    if (typeof r.value === "object") {
                        ...
                        for (var m in b) {
                            ...
                            if (q && jQuery.inArray(jQuery.trim(b[m]), j) > -1) {
                                d.selected = "selected"
                            }
                            g.appendChild(d)
                        }
    ...
    case "button":
        g = document.createElement("input");
        g.type = h;
        g.value = jQuery.jgrid.htmlDecode(f);
        r = o(g, r);
        if (!r.size) {
            jQuery(g).css({
                width: "98%"
...
function checkValues(c, l, j) {
    ...
    if (typeof(l) == "string") {
        ...
        if (l >= 0) {
            var f = j.p.colModel[l].editrules
        }
    }
    if (f) {
        if (!m) {
        ...
        if (f.date === true) {
            if (! (d === false && isEmpty(c))) {
                var b = j.p.colModel[l].datefmt || "Y-m-d";
                if (!checkDate(b, c)) {
            ...
            return this.each(function () {
                ...
                if (b.fn.searchFilter) {
                    ...
                    if (b("#" + g).html() != null) {
                        ...
                        var n = [],
                            u = jQuery("#" + l.p.id).getGridParam("colNames"),
                            r = jQuery("#" + l.p.id).getGridParam("colModel"),
                            t = ["eq", "ne", "lt", "le", "gt", "ge", "bw", "bn", "in", "ni", "ew", "en", "cn", "nc"],
                            i, q, h;
                        b.each(r, function (x, C) {
                            var z = (typeof C.search === "undefined") ? true : C.search,
                            y = (C.hidden === true),
                            k = b.extend({},
                            {
                                text: u[x],
                            ...
                            this.searchoptions),
                            w = (k.searchhidden === true) || true;
                            if (typeof k.sopt == "undefined") {
                                k.sopt = t
                            }
                            h = 0;
                            k.ops = [];
                        ...
                        if (n.length > 0) {
                            var p = jQuery.fn.searchFilter.defaults.operators;
                            if (c.sopt != null) {
                                p = [];
                                h = 0;
                ...
                function s(v) {
                    var e = (v !== undefined),
                        ...
                        j = {};
                    if (c.multipleSearch === false) {
                        j[c.sField] = v.rules[0].field;
                        j[c.sValue] = v.rules[0].data;
                        j[c.sOper] = v.rules[0].op
                    } else {
                        j[c.sFilter] = v
                    }
                    k[0].p.search = e;
                ...
                function d(e) {
                    ...
                    e.hide();
                    b(".jqgrid-overlay", "#gbox_" + l.p.id).hide()
                }

                function f() {
                    b("#" + g).show();
                    b(".jqgrid-overlay", "#gbox_" + l.p.id).show();
                    try {
        ...
        editGridRow: function (c, d) {
            ...
            return this.each(function () {
                ...
                var B = e.p.id,
                    ...
                    C = b.isFunction(a.beforeShowForm) ? a.beforeShowForm : false,
                N = b.isFunction(a.afterShowForm) ? a.afterShowForm : false,
                M = b.isFunction(a.beforeInitData) ? a.beforeInitData : false,
                n = b.isFunction(a.onInitializeForm) ? a.onInitializeForm : false,
                H = null,
                I = 1,
                p = 0,
                u,
                ...
                if (b("#" + h.themodal).html() != null) {
                    b(".ui-jqdialog-title", "#" + h.modalhead).html(d.caption);
                    b("#FormError", "#" + t).hide();
                    if (M) {
                        M(b("#" + x))
                    }
                    ...
                    if (d.processing === true) {
                        d.processing = false;
                        b("#sData", "#" + t).removeClass("ui-state-active")
                    }
                    if (b("#" + x).data("disabled") === true) {
                        b(".confirm", "#" + h.themodal).hide();
                        b("#" + x).data("disabled", false)
                    }
                    if (C) {
                        C(b("#" + x))
                    }
                    b("#" + h.themodal).data("onClose", a.onClose);
                    ...
                    b(e.p.colModel).each(function (V) {
                        var W = this.formoptions;
                        I = Math.max(I, W ? W.colpos || 0 : 0);
                        p = Math.max(p, W ? W.rowpos || 0 : 0)
                    });
                    var q = isNaN(d.dataheight) ? d.dataheight : d.dataheight + "px";
                    var L, S = b("<form name='FormPost' id='" + x + "' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:" + q + ";'></form>").data("disabled", false),
                        z = b("<table id='" + t + "' class='EditTable' cellspacing='0' cellpading='0' border='0'><tbody></tbody></table>");
                    b(S).append(z);
                    L = b("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='" + (I * 2) + "'></td></tr>");
                    L[0].rp = 0;
                    b(z).append(L);
                    if (a.topinfo) {
                        L = b("<tr><td class='topinfo' colspan='" + (I * 2) + "'>" + a.topinfo + "</td></tr>");
                        L[0].rp = 0;
                        b(z).append(L)
                    }
                    if (M) {
                    ...
                    var y = r(c, e, z, I),
                        k = "<a href='javascript:void(0)' id='pData' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></div>",
                        l = "<a href='javascript:void(0)' id='nData' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></div>",
                        g = "<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>" + d.bSubmit + "</a>",
                        s = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel + "</a>";
                    var P = "<table border='0' class='EditTable' id='" + t + "_2'><tbody><tr id='Act_Buttons'><td class='navButton ui-widget-content'>" + k + l + "</td><td class='EditButton ui-widget-content'>" + g + "&nbsp;" + s + "</td></tr>";
                    if (a.bottominfo) {
                    ...
                    if (p > 0) {
                        var w = [];
                        b.each(b(z)[0].rows, function (V, W) {
                            w[V] = W
                        });
                        w.sort(function (W, V) {
                            if (W.rp > V.rp) {
                    ...
                    var O = b("<span></span>").append(S).append(P);
                    createModal(h, O, d, "#gview_" + e.p.id, b("#gview_" + e.p.id)[0]);
                    O = null;
                    P = null;
                    jQuery("#" + h.themodal).keydown(function (V) {
                        if (b("#" + x).data("disabled") === true) {
                            return false
                        }
                        if (a.savekey[0] === true && V.which == a.savekey[1]) {
                            b("#sData", "#" + t + "_2").trigger("click");
                            return false
                        }
                        if (V.which === 27) {
                            if (!f()) {
                        ...
                        if (a.navkeys[0] === true) {
                            ...
                            if (V.which == a.navkeys[1]) {
                                b("#pData", "#" + t + "_2").trigger("click");
                                return false
                            }
                            if (V.which == a.navkeys[2]) {
                                b("#nData", "#" + t + "_2").trigger("click");
                                return false
                            }
                        }
                    });
                    if (d.checkOnUpdate) {
                        b("a.ui-jqdialog-titlebar-close span", "#" + h.themodal).removeClass("jqmClose");
                        b("a.ui-jqdialog-titlebar-close", "#" + h.themodal).unbind("click").click(function () {
                            if (!f()) {
                                return false
                            }
                            hideModal("#" + h.themodal, {
                    ...
                    if (a.checkOnSubmit || a.checkOnUpdate) {
                        g = "<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bYes + "</a>";
                        l = "<a href='javascript:void(0)' id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bNo + "</a>";
                        s = "<a href='javascript:void(0)' id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bExit + "</a>";
                        var F, v = d.zIndex || 999;
                        v++;
                        ...
                        b("<div class='ui-widget-overlay jqgrid-overlay confirm' style='z-index:" + v + ";display:none;'>&nbsp;" + F + "</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:" + (v + 1) + "'>" + d.saveData + "<br/><br/>" + g + l + s + "</div>").insertAfter("#" + x);
                        b("#sNew", "#" + h.themodal).click(function () {
                            i([true, "", ""]);
                            b("#" + x).data("disabled", false);
                            b(".confirm", "#" + h.themodal).hide();
                            return false
                    ...
                    b("#sData", "#" + t + "_2").click(function (V) {
                        ...
                        if (D.id == "_empty") {
                            ...
                            if (d.checkOnSubmit === true) {
                                ...
                                A = J(G, a._savedData);
                                if (A) {
                                    b("#" + x).data("disabled", true);
                                    b(".confirm", "#" + h.themodal).show()
                                } else {
                                    i()
                                }
                            } else {
                ...
                function T() {
                    b(".FormElement", "#" + t).each(function (W) {
                        ...
                        case "select-one":
                            ...
                            Q[this.name] = b("option:selected", this).text();
                            break;
                        case "select-multiple":
                            ...
                            var X = [];
                            b("option:selected", this).each(function (Y, Z) {
                                X[Y] = b(Z).text()
                            });
                            Q[this.name] = X.join(",");
                            break;
                        ...
                        case "button":
                            D[this.name] = b(this).val();
                            D[this.name] = !e.p.autoencode ? D[this.name] : b.jgrid.htmlEncode(D[this.name]);
                            break
                        }
                    });
                    return true
                ...
                function r(Y, ae, ab, aj) {
                    var V, W, ag, ah = 0,
                        al, am, af, ak = [],
                        ac = false,
                        ad, X, Z = "<td class='CaptionTD ui-widget-content'>&nbsp;</td><td class='DataTD ui-widget-content' style='white-space:pre'>&nbsp;</td>",
                        aa = "";
                    ...
                    b(ae.p.colModel).each(function (aq) {
                        ...
                        am = W ? "style='display:none'" : "";
                        if (V !== "cb" && V !== "subgrid" && this.editable === true && V !== "rn") {
                            if (ac === false) {
                                al = ""
                            } else {
                            ...
                            this.formoptions || {}),
                            ad = parseInt(frmopt.rowpos) || ah + 1,
                            X = parseInt((parseInt(frmopt.colpos) || 1) * 2);
                            if (Y == "_empty" && ap.defaultValue) {
                                al = b.isFunction(ap.defaultValue) ? ap.defaultValue() : ap.defaultValue
                            }
                            if (!this.edittype) {
                                this.edittype = "text"
                            }
                            af = createEl(this.edittype, ap, al);
                            if (al == "" && this.edittype == "checkbox") {
                                al = b(af).attr("offval")
                            }
                            if (a.checkOnSubmit || a.checkOnUpdate) {
                                a._savedData[V] = al
                            }
                            b(af).addClass("FormElement");
                            ag = b(ab).find("tr[rowpos=" + ad + "]");
                            if (frmopt.rowabove) {
                                var ar = b("<tr><td class='contentinfo' colspan='" + (aj * 2) + "'>" + frmopt.rowcontent + "</td></tr>");
                                b(ab).append(ar);
                                ar[0].rp = ad
                            }
                            if (ag.length == 0) {
                                ag = b("<tr " + am + " rowpos='" + ad + "'></tr>").addClass("FormData").attr("id", "tr_" + V);
                                b(ag).append(aa);
                                b(ab).append(ag);
                                ag[0].rp = ad
                            }
                            b("td:eq(" + (X - 2) + ")", ag[0]).html(typeof frmopt.label === "undefined" ? ae.p.colNames[aq] : frmopt.label);
                            b("td:eq(" + (X - 1) + ")", ag[0]).append(frmopt.elmprefix).append(af).append(frmopt.elmsuffix);
                            ak[ah] = aq;
                            ah++
                        }
                    });
                    if (ah > 0) {
                        var an = b("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (aj * 2 - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='" + Y + "'/></td></tr>");
                        an[0].rp = ah + 999;
                        b(ab).append(an);
                        if (a.checkOnSubmit || a.checkOnUpdate) {
                            a._savedData.id = Y
                ...
                function m(W, ab, X) {
                    ...
                    if (W == "_empty") {
                        b(ab.p.colModel).each(function (ag) {
                            af = this.name.replace(".", "\\.");
                            V = b.extend({},
                            this.editoptions || {});
                            aa = b("#" + af, "#" + X);
                            if (aa[0] != null) {
                                Z = "";
                                if (V.defaultValue) {
                                    Z = b.isFunction(V.defaultValue) ? V.defaultValue() : V.defaultValue;
                                    if (aa[0].type == "checkbox") {
                                        ae = Z.toLowerCase();
                                        if (ae.search(/(false|0|no|off|undefined)/i) < 0 && ae !== "") {
                                            aa[0].checked = true;
                                            aa[0].defaultChecked = true;
                                            aa[0].value = Z
                                        } else {
                                            aa.attr({
                                                checked: "",
                    ...
                    b("table:first tr#" + W + " td", ab.grid.bDiv).each(function (ah) {
                        af = ab.p.colModel[ah].name.replace(".", "\\.");
                        if (ab.p.colModel[ah].editrules && ab.p.colModel[ah].editrules.edithidden === true) {
                            ad = false
                        } else {
                            ad = ab.p.colModel[ah].hidden === true ? true : false
                        }
                        if (af !== "cb" && af !== "subgrid" && ab.p.colModel[ah].editable === true) {
                            if (af == ab.p.ExpandColumn && ab.p.treeGrid === true) {
                                ac = b(this).text()
                            } else {
                                try {
                                    ac = b.unformat(this, {
                                        colModel: ab.p.colModel[ah]
                                    },
                                    ah)
                                } catch(ag) {
                                    ac = b(this).html()
                            ...
                            switch (ab.p.colModel[ah].edittype) {
                            case "password":
                            case "text":
                            case "button":
                            case "image":
                                ac = b.jgrid.htmlDecode(ac);
                                b("#" + af, "#" + X).val(ac);
                                break;
                            case "textarea":
                                if (ac == "&nbsp;" || ac == "&#160;" || (ac.length == 1 && ac.charCodeAt(0) == 160)) {
                                    ac = ""
                                }
                                b("#" + af, "#" + X).val(ac);
                                break;
                            case "select":
                                ac = b.jgrid.htmlDecode(ac);
                                b("#" + af + " option", "#" + X).each(function (ai) {
                                    if (!ab.p.colModel[ah].editoptions.multiple && ac == b(this).text()) {
                                        this.selected = true
                                    } else {
                                        if (ab.p.colModel[ah].editoptions.multiple) {
                                            if (b.inArray(b(this).text(), ac.split(",")) > -1) {
                                                this.selected = true
                                            } else {
                                                this.selected = false
                                            }
                            ...
                            case "checkbox":
                                ac = ac.toLowerCase();
                                if (ac.search(/(false|0|no|off|undefined)/i) < 0 && ac !== "") {
                                    b("#" + af, "#" + X).attr("checked", true);
                                    b("#" + af, "#" + X).attr("defaultChecked", true)
                                } else {
                                    b("#" + af, "#" + X).attr("checked", false);
                                    b("#" + af, "#" + X).attr("defaultChecked", "")
                                }
                                break
                            }
                            Y++
                ...
                function i() {
                    ...
                    u = a.url ? a.url : e.p.editurl;
                    if (W[0]) {
                        if (!u) {
                            W[0] = false;
                            W[1] += " " + b.jgrid.errors.nourl
                        }
                    }
                    if (W[0] === false) {
                        b("#FormError>td", "#" + t).html(W[1]);
                        b("#FormError", "#" + t).show();
                        return
                    }
                    if (!d.processing) {
                        d.processing = true;
                        b("#sData", "#" + t + "_2").addClass("ui-state-active");
                        D.oper = D.id == "_empty" ? "add" : "edit";
                        D = b.extend(D, a.editData, V);
                        b.ajax({
                            url: u,
                            type: a.mtype,
                            data: D,
                            complete: function (aa, Z) {
                                ...
                                b("#sData", "#" + t + "_2").removeClass("ui-state-active");
                                try {
                                    b(":input:visible", "#" + x)[0].focus()
                                } catch(ab) {}
                            },
                            error: function (ab, Z, aa) {
                                b("#FormError>td", "#" + t).html(Z + " : " + aa);
                                b("#FormError", "#" + t).show();
                                d.processing = false;
                                b("#" + x).data("disabled", false);
                                b("#sData", "#" + t + "_2").removeClass("ui-state-active")
            ...
            return this.each(function () {
                ...
                if (b("#" + i.themodal).html() != null) {
                    ...
                    b(w.p.colModel).each(function (C) {
                        var D = this.formoptions;
                        g = Math.max(g, D ? D.colpos || 0 : 0);
                        e = Math.max(e, D ? D.rowpos || 0 : 0)
                    });
                    var x = isNaN(d.dataheight) ? d.dataheight : d.dataheight + "px";
                    var v, A = b("<form name='FormPost' id='" + y + "' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:" + x + ";'></form>"),
                        k = b("<table id='" + r + "' class='EditTable' cellspacing='1' cellpading='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");
                    b(A).append(k);
                    var u = m(c, w, k, g),
                        s = "<a href='javascript:void(0)' id='pData' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></div>",
                        t = "<a href='javascript:void(0)' id='nData' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></div>",
                        B = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>" + d.bClose + "</a>";
                    if (e > 0) {
                        var f = [];
                        b.each(b(k)[0].rows, function (C, D) {
                            f[C] = D
                        });
                        f.sort(function (D, C) {
                            if (D.rp > C.rp) {
                    ...
                    var z = b("<span></span>").append(A).append("<table border='0' class='EditTable' id='" + r + "_2'><tbody><tr id='Act_Buttons'><td class='navButton ui-widget-content' width='" + d.labelswidth + "'>" + s + t + "</td><td class='EditButton ui-widget-content'>" + B + "</td></tr></tbody></table>");
                    createModal(i, z, d, "#gview_" + w.p.id, b("#gview_" + w.p.id)[0]);
                    z = null;
                    jQuery("#" + i.themodal).keydown(function (C) {
                        if (C.which === 27) {
                            if (p) {
                                hideModal(this, {
                                    gb: d.gbox,
                        ...
                        if (d.navkeys[0] === true) {
                            if (C.which === d.navkeys[1]) {
                                b("#pData", "#" + r + "_2").trigger("click");
                                return false
                            }
                            if (C.which === d.navkeys[2]) {
                                b("#nData", "#" + r + "_2").trigger("click");
                                return false
                            }
                        }
                    });
                ...
                function m(I, O, M, U) {
                    var E, H, P, X, C, S = 0,
                        W, Y, V = [],
                        N = false,
                        K = "<td class='CaptionTD ui-widget-content' width='" + d.labelswidth + "'>&nbsp;</td><td class='DataTD ui-helper-reset ui-widget-content' style='white-space:pre;'>&nbsp;</td>",
                        L = "",
                        F = "<td class='CaptionTD ui-widget-content'>&nbsp;</td><td class='DataTD ui-widget-content' style='white-space:pre;'>&nbsp;</td>",
                        J = ["integer", "number", "currency"],
                        R = 0,
                        Q = 0,
                        G, D;
                    for (var T = 1; T <= U; T++) {
                    ...
                    G = R !== 0 ? R : Q !== 0 ? Q : 0;
                    N = b(O).getInd(I);
                    b(O.p.colModel).each(function (ab) {
                        E = this.name;
                        D = false;
                        if (this.editrules && this.editrules.edithidden === true) {
                            H = false
                        ...
                        if (E !== "cb" && E !== "subgrid" && this.editable === true) {
                            if (N === false) {
                                W = ""
                            } else {
                            ...
                            D = this.align === "right" && G !== 0 ? true : false;
                            var aa = b.extend({},
                            this.editoptions || {},
                            {
                                id: E,
                            ...
                            this.formoptions || {}),
                                ac = parseInt(af.rowpos) || S + 1,
                                ae = parseInt((parseInt(af.colpos) || 1) * 2);
                            if (af.rowabove) {
                                var ad = b("<tr><td class='contentinfo' colspan='" + (U * 2) + "'>" + af.rowcontent + "</td></tr>");
                                b(M).append(ad);
                                ad[0].rp = ac
                            }
                            P = b(M).find("tr[rowpos=" + ac + "]");
                            if (P.length == 0) {
                                P = b("<tr " + Y + " rowpos='" + ac + "'></tr>").addClass("FormData").attr("id", "trv_" + E);
                                b(P).append(L);
                                b(M).append(P);
                                P[0].rp = ac
                            }
                            b("td:eq(" + (ae - 2) + ")", P[0]).html("<b>" + (typeof af.label === "undefined" ? O.p.colNames[ab] : af.label) + "</b>");
                            b("td:eq(" + (ae - 1) + ")", P[0]).append("<span>" + W + "</span>").attr("id", "v_" + E);
                            if (D) {
                    ...
                    if (S > 0) {
                        var Z = b("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (U * 2 - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='" + I + "'/></td></tr>");
                        Z[0].rp = S + 99;
                        b(M).append(Z)
                    }
                    return V
                ...
                function l(G, H) {
                    var C, I, F = 0,
                        E, D;
                    b("#" + G + " td", H.grid.bDiv).each(function (J) {
                        C = H.p.colModel[J].name.replace(".", "\\.");
                        if (H.p.colModel[J].editrules && H.p.colModel[J].editrules.edithidden === true) {
                            I = false
                        } else {
                            I = H.p.colModel[J].hidden === true ? true : false
                        }
                        if (C !== "cb" && C !== "subgrid" && H.p.colModel[J].editable === true) {
                            if (C == H.p.ExpandColumn && H.p.treeGrid === true) {
                                E = b(this).text()
                            } else {
                                E = b(this).html()
                            }
                            D = b.extend({},
                            H.p.colModel[J].editoptions || {});
                            C = "v_" + C;
                            b("#" + C + " span", "#" + r).html(E);
                            if (I) {
        ...
        delGridRow: function (c, d) {
            ...
            return this.each(function () {
                ...
                if (b("#" + h.themodal).html() != null) {
                    ...
                    k += "<tr id='DelError' style='display:none'><td ></td></tr>";
                ...
                if (h.refresh) {
                    ...
                    b(p, q).attr({
                        ...
                        case "firstpage":
                            ...
                            break;
                        case "current":
                            var t = n.p.multiselect === true ? n.p.selarrrow : n.p.selrow;
                            b(n).trigger("reloadGrid");
                            setTimeout(function () {
...
jQuery.fn.searchFilter = function (a, c) {
    function b(j, p, g) {
        ...
        if (p != null) {
            ...
            var n = jQuery.extend({},
            jQuery.fn.searchFilter.defaults, g);
            var y = -1;
            var x = "";
            ...
            var t = false;
            var d = false;
            jQuery.each(p, function (B) {
                var A = B;
                u += e(this.value, this.text);
                if (this.ops != null) {
                    t = true;
                    var z = "";
                ...
                if (this.dataUrl != null) {
                    ...
                    var C = this.dataInit;
                    jQuery.get(this.dataUrl, function (G) {
                        var F = jQuery("<div />").append(G);
                    ...
                    if (this.dataValues != null) {
                        ...
                        if (this.dataEvents != null || this.dataInit != null) {
                            d = true;
                            var D = "<input type='text' class='field" + A + "' />";
                            o.append(D)
                        }
                    }
                }
            ...
            if (d) {
                m.change(function (B) {
                    ...
                    C.find("select,input").removeAttr("name").hide();
                    var z = C.find(".field" + A);
                    if (z[0] == null) {
                        z = C.find(".default")
                    }
            ...
            j.find(".ui-search").click(function (C) {
                ...
                B.find(".sf").each(function (D) {
                    ...
                    var E = jQuery(this).find("input[name='data'],select[name='data'] :selected").val();
                    if (!n.stringResult) {
                        z.rules.push({
                            field: G,
                            op: F,
    ...
    a.fn.extend({
        editRow: function (c, i, h, j, b, e, d, f, g) {
            return this.each(function () {
                ...
                if (l == "0") {
                    q = n.p.colModel;
                    a("td", k).each(function (x) {
                        t = q[x].name;
                        p = q[x].hidden === true ? true : false;
                        var w = n.p.treeGrid === true && t == n.p.ExpandColumn;
                        if (w) {
                        ...
                        if (t != "cb" && t != "subgrid" && t != "rn") {
                            r[t] = o;
                            if (q[x].editable === true && !p) {
                                if (s === null) {
                                    s = x
                                }
                                if (w) {
                                ...
                                var y = createEl(q[x].edittype, v, o, a(this));
                                a(y).addClass("editable");
                                if (w) {
                                    a("span:first", this).append(y)
                                } else {
                                    a(this).append(y)
                                }
                                if (q[x].edittype == "select" && q[x].editoptions.multiple === true && a.browser.msie) {
                                    a(y).width(a(y).width())
                                }
                                m++
                            }
                    ...
                    if (m > 0) {
                        ...
                        n.p.savedRow.push(r);
                        a(k).attr("editable", "1");
                        a("td:eq(" + s + ") input", k).focus();
                        if (i === true) {
                            a(k).bind("keydown", function (u) {
                                if (u.keyCode === 27) {
                                    a(n).restoreRow(c, g)
                                }
                                if (u.keyCode === 13) {
                                    a(n).saveRow(c, j, b, e, d, f, g);
                                    return false
                                }
                                u.stopPropagation()
                            })
        ...
        saveRow: function (h, g, e, f, d, c, b) {
            return this.each(function () {
                ...
                e = e ? e : o.p.editurl;
                if (j === "1" && e) {
                    a("td", i).each(function (u) {
                        t = o.p.colModel[u].name;
                        if (t != "cb" && t != "subgrid" && o.p.colModel[u].editable === true && t != "rn") {
                            if (o.p.colModel[u].hidden === true) {
                                p[t] = a(this).html()
                            } else {
                                switch (o.p.colModel[u].edittype) {
                                case "checkbox":
                                    var k = ["Yes", "No"];
                                    if (o.p.colModel[u].editoptions) {
                                        k = o.p.colModel[u].editoptions.value.split(":")
                                    }
                                    p[t] = a("input", this).attr("checked") ? k[0] : k[1];
                                    break;
                                case "text":
                                case "password":
                                case "textarea":
                                case "button":
                                    p[t] = !o.p.autoencode ? a("input, textarea", this).val() : a.jgrid.htmlEncode(a("input, textarea", this).val());
                                    break;
                                case "select":
                                    if (!o.p.colModel[u].editoptions.multiple) {
                                        p[t] = a("select>option:selected", this).val();
                                        l[t] = a("select>option:selected", this).text()
                                    } else {
                                        var v = a("select", this),
                                            w = [];
                                        p[t] = a(v).val();
                                        ...
                                        a("select > option:selected", this).each(function (x, y) {
                                            w[x] = a(y).text()
                                        });
                                        l[t] = w.join(",")
                                    }
                            ...
                            a.ajax({
                                ...
                                complete: function (w, x) {
                                    if (x === "success") {
                                        ...
                                        if (v === true) {
                                            ...
                                            a(o).setRowData(h, p);
                                            a(i).attr("editable", "0");
                                            for (var u = 0; u < o.p.savedRow.length; u++) {
                                                if (o.p.savedRow[u].id == h) {
                                                    r = u;
                                                    break
                                                }
                                            }
                                ...
                                error: function (k, u) {
                                    if (a.isFunction(c)) {
                                        ...
                                        alert("Error Row: " + h + " Result: " + k.status + ":" + k.statusText + " Status: " + u)
                                    }
                                }
                            })
                        }
        ...
        restoreRow: function (c, b) {
            return this.each(function () {
                ...
                if (d >= 0) {
                    a(g).setRowData(c, g.p.savedRow[d]);
                    a(f).attr("editable", "0");
    ...
    a.fn.extend({
        editCell: function (d, c, b) {
            return this.each(function () {
                ...
                if (j.p.savedRow.length > 0) {
                    ...
                    var h = a("td:eq(" + j.p.savedRow[0].ic + ")>#" + j.p.savedRow[0].id + "_" + j.p.savedRow[0].name.replace(".", "\\."), j.rows[j.p.savedRow[0].id]).val();
                ...
                if (j.p.colModel[c].editable === true && b === true) {
                    ...
                    var e = createEl(j.p.colModel[c].edittype, f, k, g);
                    ...
                    a("td:eq(" + c + ")", j.rows[d]).addClass("edit-cell ui-state-highlight");
                    a(j.rows[d]).addClass("selected-row ui-state-hover");
                    if (a.isFunction(j.p.onSelectCell)) {
                        k = a("td:eq(" + c + ")", j.rows[d]).html().replace(/\&nbsp\;/ig, "");
        ...
        saveCell: function (c, b) {
            return this.each(function () {
                ...
                if (l != null) {
                    var g = a("td:eq(" + b + ")", j.rows[c]),
                        q, o, r = j.p.colModel[b].name.replace(".", "\\.");
                    switch (j.p.colModel[b].edittype) {
                    case "select":
                        if (!j.p.colModel[b].editoptions.multiple) {
                            q = a("#" + c + "_" + r.replace(".", "\\.") + ">option:selected", j.rows[c]).val();
                            o = a("#" + c + "_" + r.replace(".", "\\.") + ">option:selected", j.rows[c]).text()
                        } else {
                            var d = a("#" + c + "_" + r.replace(".", "\\."), j.rows[c]),
                                f = [];
                            q = a(d).val();
                            if (q) {
                                q.join(",")
                    ...
                    case "checkbox":
                        var h = ["Yes", "No"];
                        if (j.p.colModel[b].editoptions) {
                            h = j.p.colModel[b].editoptions.value.split(":")
                        }
                        q = a("#" + c + "_" + r.replace(".", "\\."), j.rows[c]).attr("checked") ? h[0] : h[1];
                        o = q;
                        break;
                    case "password":
                    case "text":
                    case "textarea":
                    case "button":
                        q = !j.p.autoencode ? a("#" + c + "_" + r.replace(".", "\\."), j.rows[c]).val() : a.jgrid.htmlEncode(a("#" + c + "_" + r.replace(".", "\\."), j.rows[c]).val());
                        o = q;
                        break
                    }
                    if (o != j.p.savedRow[l].v) {
                        if (a.isFunction(j.p.beforeSaveCell)) {
                            var p = j.p.beforeSaveCell(j.rows[c].id, r, q, c, b);
                            if (p) {
                                q = p
                            }
                        }
                        var i = checkValues(q, b, j);
                        if (i[0] === true) {
                            var k = {};
                            if (a.isFunction(j.p.beforeSubmitCell)) {
                                k = j.p.beforeSubmitCell(j.rows[c].id, r, q, c, b);
                                if (!k) {
                                    k = {}
                                }
                            }
                                    ...
                                    a.ajax({
                                        ...
                                        complete: function (e, t) {
                                            if (t == "success") {
                                                if (a.isFunction(j.p.afterSubmitCell)) {
                                                    var s = j.p.afterSubmitCell(e, n.id, r, q, c, b);
                                                    if (s[0] === true) {
                                                        a(g).empty();
                                                        a(j).setCell(j.rows[c].id, b, o);
                                                        a(g).addClass("dirty-cell");
                                                        a(j.rows[c]).addClass("edited");
                                                        if (a.isFunction(j.p.afterSaveCell)) {
                                        ...
                                        error: function (e, s) {
                                            if (a.isFunction(j.p.errorCell)) {
                                                ...
                                                info_dialog(a.jgrid.errors.errcap, e.status + " : " + e.statusText + "<br/>" + s, a.jgrid.edit.bClose);
                                                a(j).restoreCell(c, b)
                                            }
                                        }
                                    })
        ...
        restoreCell: function (c, b) {
            return this.each(function () {
                ...
                if (d != null) {
                    ...
                    a(h).setCell(h.rows[c].id, b, h.p.savedRow[d].v);
        ...
        GridNav: function () {
            return this.each(function () {
                ...
                f.p.knv = a("table:first", f.grid.bDiv).attr("id") + "_kn";
                var e = a("<span style='width:0px;height:0px;background-color:black;' tabindex='0'><span tabindex='-1' style='width:0px;height:0px;background-color:grey' id='" + f.p.knv + "'></span></span>"),
                    c;
                a(e).insertBefore(f.grid.cDiv);
                a("#" + f.p.knv).focus();
                a("#" + f.p.knv).keydown(function (g) {
                    switch (g.keyCode) {
                    case 38:
                        if (f.p.iRow - 1 >= 0) {
                            d(f.p.iRow - 1, f.p.iCol, "vu");
                            a(f).editCell(f.p.iRow - 1, f.p.iCol, false)
                        }
                        break;
                    case 40:
                        if (f.p.iRow + 1 <= f.rows.length - 1) {
                            d(f.p.iRow + 1, f.p.iCol, "vd");
                            a(f).editCell(f.p.iRow + 1, f.p.iCol, false)
                        }
                        break;
                    case 37:
                        if (f.p.iCol - 1 >= 0) {
                            c = b(f.p.iCol - 1, "lft");
                            d(f.p.iRow, c, "h");
                            a(f).editCell(f.p.iRow, c, false)
                        }
                        break;
                    case 39:
                        if (f.p.iCol + 1 <= f.p.colModel.length - 1) {
                            c = b(f.p.iCol + 1, "rgt");
                            d(f.p.iRow, c, "h");
                            a(f).editCell(f.p.iRow, c, false)
                        }
                ...
                function d(o, m, n) {
                    if (n.substr(0, 1) == "v") {
                        var g = a(f.grid.bDiv)[0].clientHeight,
                            p = a(f.grid.bDiv)[0].scrollTop,
                            q = f.rows[o].offsetTop + f.rows[o].clientHeight,
                            k = f.rows[o].offsetTop;
                        if (n == "vd") {
                            if (q >= g) {
                    ...
                    if (n == "h") {
                        var j = a(f.grid.bDiv)[0].clientWidth,
                            i = a(f.grid.bDiv)[0].scrollLeft,
                            h = f.rows[o].cells[m].offsetLeft + f.rows[o].cells[m].clientWidth,
                            l = f.rows[o].cells[m].offsetLeft;
                        if (h >= j + parseInt(i)) {
                ...
                function b(k, g) {
                    ...
                    if (g == "rgt") {
                        j = k - 1;
                        for (h = k; h < f.p.colModel.length; h++) {
                            if (f.p.colModel[h].hidden !== true) {
                                j = h;
                                break
                            }
            ...
            return this.each(function () {
                ...
                a("td:eq(" + c + ")", b).click(function (q) {
                    if (a(this).hasClass("sgcollapsed")) {
                        ...
                        g = "<tr role='row' class='ui-subgrid'>" + j + "<td><span class='ui-icon ui-icon-carat-1-sw'/></td><td colspan='" + parseInt(m.p.colNames.length - 1 - k) + "' class='ui-widget-content subgrid-data'><div id=" + p + "_" + o + " class='tablediv'>";
                ...
                var d = function (v, t) {
                    ...
                    for (u = 0; u < m.p.subGridModel[0].name.length; u++) {
                        x = a("<th class='ui-state-default ui-th-column'></th>");
                ...
                var f = function (x, u) {
                    ...
                    for (v = 0; v < m.p.subGridModel[0].name.length; v++) {
                        z = a("<th class='ui-state-default ui-th-column'></th>");
    ...
    a.fn.extend({
        setTreeNode: function (b, c) {
            return this.each(function () {
                ...
                var d = "<div class='tree-wrap' style='width:" + (h * 18) + "px;'>";
                d += "<div style='left:" + (l * 18) + "px;' class='ui-icon ";
                ...
                a(".treeclick", c).bind("click", function (o) {
                    ...
                    if (!g.rows[m].isLeaf) {
                        if (g.rows[m].expanded) {
                            a(g).collapseRow(g.rows[m]);
                            a(g).collapseNode(g.rows[m])
                        } else {
                            a(g).expandRow(g.rows[m]);
                            a(g).expandNode(g.rows[m])
                        }
                    }
                    return false
                });
        ...
        getNodeDepth: function (c) {
            ...
            this.each(function () {
                ...
                case "nested":
                    ...
                    break;
                case "adjacency":
                    b = a(d).getNodeAncestors(c).length;
                    break
                }
            });
            return b
        ...
        SortTree: function (b) {
            return this.each(function () {
                ...
                for (f = 0, c = d.length; f < c; f++) {
                    g = d[f];
                    e.push(g);
                    a(this).collectChildrenSortTree(e, g, b)
                }
        ...
        collectChildrenSortTree: function (b, d, c) {
            return this.each(function () {
                ...
                var g, e, h, f = a(this).getNodeChildren(d);
                f.sort(function (j, i) {
                    if (j.sortKey < i.sortKey) {
                        return -c
                    }
                ...
                for (g = 0, e = f.length; g < e; g++) {
                    h = f[g];
                    b.push(h);
                    a(this).collectChildrenSortTree(b, h, c)
                }
            })
        },
        ...
        delTreeNode: function (b) {
            return this.each(function () {
                ...
                var d = a(f).getInd(b, true);
                if (d) {
                    var e = a(f).getNodeChildren(d);
                    if (e.length > 0) {
                        for (var c = 0; c < e.length; c++) {
                ...
                if (b === null) {
                    ...
                    if (typeof(b) === "object") {
                        ...
                        if (typeof(b) === "string") {
                            ...
                            var k = /function/i;
                            b = b.toString();
                            if (h.test(b) || k.test(b) || b === "false" || b === "true") {
                                j += (a && ":") + b
                            } else {
                                j += (a && ":") + '"' + b + '"'
                            }
                ...
                if (a("#" + f.themodal).html() != null) {
                    ...
                    for (i = 0; i < this.p.colNames.length; i++) {
                        if (!j.p.colModel[i].hidedlg) {
                            m += "<tr><td style='white-space: pre'><input type='checkbox' id='col_" + this.p.colModel[i].name + "' class='cbox' value='T' " + ((this.p.colModel[i].hidden === false) ? "checked" : "") + "/><label for='col_" + this.p.colModel[i].name + "'>" + this.p.colNames[i] + ((b.colnameview) ? " (" + this.p.colModel[i].name + ")" : "") + "</label></td></tr>"
                        }
                    }
                    m += "</tbody></table></div>";
                    var g = "<a href='javascript:void(0)' id='dData' class='fm-button ui-state-default ui-corner-all'>" + b.bSubmit + "</a>",
                    ...
                    a("#dData", "#" + h + "_2").click(function (p) {
                        for (i = 0; i < j.p.colModel.length; i++) {
                            if (!j.p.colModel[i].hidedlg) {
                                ...
                                if (a("#col_" + o).attr("checked")) {
                                    a(j).showCol(j.p.colModel[i].name);
                                    a("#col_" + o).attr("defaultChecked", true)
                                } else {
                                    a(j).hideCol(j.p.colModel[i].name);
                                    a("#col_" + o).attr("defaultChecked", "")
                                }
                            }
                        }
                        if (b.ShrinkToFit === true) {
                            a(j).setGridWidth(j.grid.width - 0.01, true)
                        }
