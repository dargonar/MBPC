...
jQuery.fn.daterangepicker = function(settings) {
    ...
    var options = jQuery.extend({
        presetRanges: [
            { text: 'Todos', dateStart: function() { return Date.parse('-15years'); }, dateEnd: function() { return Date.parse('+200years'); } },
			{ text: 'Hoy', dateStart: 'today', dateEnd: 'today' },
			{ text: 'Ultima Semana', dateStart: 'today-7days', dateEnd: 'today' },
			{ text: 'Mesta hasta la fecha', dateStart: function() { return Date.parse('today').moveToFirstDayOfMonth(); }, dateEnd: 'today' },
			{ text: 'Año hasta la fecha', dateStart: function() { var x = Date.parse('today'); x.setMonth(0); x.setDate(1); return x; }, dateEnd: 'today' },
        //extras:
        ...
        presets: {
            ...
            allDatesBefore: 'Todos antes de',
            allDatesAfter: 'Todos despues de',
        ...
        latestDate: Date.parse('+200years'), //latest date allowed 
    ...
    function showRP() {
        if (rp.data('state') == 'closed') {
            ...
            rp.parent().css('position', 'absolute');
            rp.parent().css('left', rangeInput.offset().left);
            rp.parent().css('top', rangeInput.offset().top + 20);
