...
public static class DaoLib
{
  ...
  public static List<object> separar_convoy(string viaje)
  {
    var parameters = new OracleParameter[] 
    { 
        new OracleParameter("vViaje", OracleDbType.Varchar2, viaje, System.Data.ParameterDirection.Input)
  ...
  public static List<object> pasar_barco(string viajeId, string zonaId)
  {
    var parameters = new OracleParameter[] 
    { 
  ...
  public static List<object> crear_usuario(string NDOC, string PASSWORD, string APELLIDO, string NOMBRES, string DESTINO, string FECHAVENC, string TEDIRECTO, string TEINTERNO, string EMAIL, string ESTADO, string SECCION, string NDOC_ADMIN, string FECHA_AUDIT, string NOMBREDEUSUARIO, string USUARIO_ID, bool edit)
  {
    var parameters = new OracleParameter[] 
    { 
    ...
    if (edit)
      return doCall("mbpc.update_usuario", parameters);
    else
      return doCall("mbpc.crear_usuario", parameters);
  }


  public static List<object> crear_viaje(string buque, string origen, string destino, DateTime inicio, DateTime eta, DateTime zoe, string zona, string proximo_punto, string intl)
  {
    var parameters = new OracleParameter[] 
    { 
  ...
  public static List<object> editar_viaje(string viaje, string buque, string origen, string destino, DateTime inicio, DateTime eta, DateTime zoe, string zona, string proximo_punto, string intl)
  {
    var parameters = new OracleParameter[] 
    { 
        new OracleParameter("vViaje", OracleDbType.Varchar2, viaje, System.Data.ParameterDirection.Input),
  ...
  public static List<object> editar_etapa(string etapa, string calado_proa, string calado_popa, DateTime? hpr, DateTime? eta, DateTime? fecha_salida, DateTime? fecha_llegada, string cantidad_tripulantes, string cantidad_pasajeros, string capitan, string velocidad, string rumbo, string latitud, string longitud)
  {
    var parameters = new OracleParameter[] 
    { 
        new OracleParameter("vEtapa", OracleDbType.Varchar2, etapa, System.Data.ParameterDirection.Input),
        ...
        new OracleParameter("vHPR", OracleDbType.Date, hpr, System.Data.ParameterDirection.Input),
        new OracleParameter("vETA", OracleDbType.Date, eta, System.Data.ParameterDirection.Input),
        new OracleParameter("vFechaSalida", OracleDbType.Date, fecha_salida, System.Data.ParameterDirection.Input),
        new OracleParameter("vFechaLlegada", OracleDbType.Date, fecha_llegada, System.Data.ParameterDirection.Input),
        ...
        new OracleParameter("vLatitud", OracleDbType.Varchar2, latitud, System.Data.ParameterDirection.Input),
        new OracleParameter("vLongitud", OracleDbType.Varchar2, longitud, System.Data.ParameterDirection.Input)
    };
  ...
  public static List<object> terminar_viaje(string viajeId)
  {
    var parameters = new OracleParameter[] 
    { 
        new OracleParameter("vViajeId", OracleDbType.Varchar2, decimal.Parse(viajeId), System.Data.ParameterDirection.Input)
  ...
  public static List<object> autocompleterb(string query)
  {
    ...
    return doCall("mbpc.autocompleterb", parameters);
  }
    ...
    using (OracleConnection con = new OracleConnection(constr))
    {
      ...
      while (reader.Read())
      {
        ...
        for (int i = 0; i < reader.FieldCount; i++)
        {
          ...
          typetemp = reader.GetValue(i).GetType();


          if (typetemp == typeof(DateTime))
          {
            vv[reader.GetName(i).ToString()] = DateTime.Parse(reader.GetValue(i).ToString()).ToString("u", DateTimeFormatInfo.InvariantInfo).Substring(0, 16);
            continue;
          }
          vv[reader.GetName(i).ToString()] = reader.GetValue(i).ToString();
        }
