...
<script type="text/javascript">
  ...
  var referenceId = <%= ViewData["userid"] == null ? "null" : "'" + ViewData["userid"] + "'"%>;
  ...
  $(document).ready(function () {
    ...
    $(function () {
      var mygrid = $("#list").jqGrid({
        url: '/Puntodecontrol/ListPDCUserJSON?userid=<%=ViewData["userid"]%>',
        datatype: 'json',
        mtype: 'GET',
      ...
      mygrid.navGrid('#pager', { edit: false,
        ...
        caption: "Asignar Punto de control",
        buttonicon: "ui-icon-add",
        onClickButton: function () {
            window.location = '/Puntodecontrol/NewAsig?user='+referenceId;
        },
        position: "last"
      }).navButtonAdd('#pager', {
        caption: "Eliminar Asignacion",
        buttonicon: "ui-icon-add",
        onClickButton: function () {
            ...
            if (!confirm("esta seguro de eliminar esta asignacion?"))
              return;
            window.location = '/Puntodecontrol/RemoveAsig?user='+referenceId+'&pdc='+id;
        },
        position: "last"
      });
    });
