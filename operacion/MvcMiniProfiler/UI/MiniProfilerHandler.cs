...
namespace MvcMiniProfiler.UI
{
    ...
    {
        internal static MvcHtmlString RenderIncludes(MiniProfiler profiler, RenderPosition? position = null, bool? showTrivial = null, bool? showTimeWithChildren = null, int? maxTracesToShow = null, bool xhtml = false, bool? showControls = null)
        {
            const string format =
...
<script type=""text/javascript"">
    jQuery(function() {{
        ...
        private static string Results(HttpContext context)
        {
            ...
            var isPopup = !context.Request.QueryString["popup"].IsNullOrWhiteSpace();

            // this guid is the MiniProfiler.Id property
            Guid id;
            if (!GuidTryParse(context.Request.QueryString["id"], out id))
        ...
        private static bool GuidTryParse(string input, out Guid result)
        {
            if (input == null)
